...
class DescribeCommonSecurityPolicyRequest(Gs2BasicRequest):

    class Constant(Gs2Identifier):
        FUNCTION = "DescribeSecurityPolicy"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeCommonSecurityPolicyRequest, self).__init__(params)
        if params is None:
    ...
    def with_page_token(self, page_token):
        ...
        :type page_token: unicode
        :return: this
        :rtype: DescribeCommonSecurityPolicyRequest
        """
